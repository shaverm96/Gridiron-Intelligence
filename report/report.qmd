...
format:
  ...
  pdf:
    ...
    toc: false # Removes Table of Contents from PDF
    number-sections: true
    number-depth: 3
    colorlinks: true
    classoption: [11pt, oneside, titlepage] # titlepage forces the separate title page
    geometry:
      - margin=0.75in
      - heightrounded
    linestretch: 1.15
    include-in-header:
      text: |
        ...
        % Scale graphics and diagrams to fit page width
        \makeatletter
        \let\Oldincludegraphics\includegraphics
        \renewcommand{\includegraphics}[2][]{%
          \Oldincludegraphics[width=\linewidth,height=\textheight,keepaspectratio]{#2}%
        }
        \makeatother
---
