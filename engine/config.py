...
CONFIG = {
    ...
    "SUMMARY_PROMPT_PAYLOAD_MAX_CHARS": int(os.getenv("GI_SUMMARY_PROMPT_PAYLOAD_MAX_CHARS", "24000")),
    "FINAL_PROMPT_MAX_CHARS": int(os.getenv("GI_FINAL_PROMPT_MAX_CHARS", "20000")),
    "SUMMARY_MAX_OUTPUT_TOKENS": int(os.getenv("GI_SUMMARY_MAX_OUTPUT_TOKENS", "2200")),
